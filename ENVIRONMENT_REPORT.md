...
| `npm test` | Unit/service regression | PASS | Son durumda 16 test dosyası, 75 test geçti |
...
| `node scripts/scan-secrets.mjs` | Kaynak secret taraması | PASS | 175 Git kapsamlı dosya tarandı, hit yok |
| `npm run qa:uat` | Lokal Chrome UAT smoke | PASS | 10/10, rapor `qa-artifacts/uat-smoke-2026-05-26T13-53-11-761Z/uat-smoke-report.md` |
