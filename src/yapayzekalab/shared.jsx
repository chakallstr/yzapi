...
const MODELS = [
  ...
  { id: 'gpt-5.5', label: 'GPT-5.5', provider: 'openai', type: 'text', input: 1.15, output: 1.15, ctx: '1M' },
  { id: 'gpt-5.5-2026-04-23', label: 'GPT-5.5 2026-04-23', provider: 'openai', type: 'text', input: 1.15, output: 1.15, ctx: '1M' },
  ...
  { id: 'gpt-5.4-mini', label: 'GPT-5.4 mini', provider: 'openai', type: 'text', input: 0.9, output: 0.9, ctx: '1M' },
  { id: 'gpt-5.4-mini-2026-03-17', label: 'GPT-5.4 mini 2026-03-17', provider: 'openai', type: 'text', input: 0.9, output: 0.9, ctx: '1M' },
  { id: 'gpt-5.4-nano', label: 'GPT-5.4 nano', provider: 'openai', type: 'text', input: 0.85, output: 0.85, ctx: '1M' },
  { id: 'gpt-5.4-nano-2026-03-17', label: 'GPT-5.4 nano 2026-03-17', provider: 'openai', type: 'text', input: 0.85, output: 0.85, ctx: '1M' },
  { id: 'gpt-5.3-chat-latest', label: 'GPT-5.3 Chat Latest', provider: 'openai', type: 'text', input: 0.8, output: 0.8, ctx: '1M' },
  { id: 'gpt-5.2', label: 'GPT-5.2', provider: 'openai', type: 'text', input: 0.75, output: 0.75, ctx: '1M' },
  { id: 'gpt-5.2-2025-12-11', label: 'GPT-5.2 2025-12-11', provider: 'openai', type: 'text', input: 0.75, output: 0.75, ctx: '1M' },
  { id: 'gpt-5.2-chat-latest', label: 'GPT-5.2 Chat Latest', provider: 'openai', type: 'text', input: 0.75, output: 0.75, ctx: '1M' },
  { id: 'gpt-5.1', label: 'GPT-5.1', provider: 'openai', type: 'text', input: 0.72, output: 0.72, ctx: '1M' },
  { id: 'gpt-5.1-2025-11-13', label: 'GPT-5.1 2025-11-13', provider: 'openai', type: 'text', input: 0.72, output: 0.72, ctx: '1M' },
  { id: 'gpt-5.1-chat-latest', label: 'GPT-5.1 Chat Latest', provider: 'openai', type: 'text', input: 0.72, output: 0.72, ctx: '1M' },
  { id: 'gpt-5', label: 'GPT-5', provider: 'openai', type: 'text', input: 0.69, output: 0.69, ctx: '1M' },
  { id: 'gpt-5-2025-08-07', label: 'GPT-5 2025-08-07', provider: 'openai', type: 'text', input: 0.69, output: 0.69, ctx: '1M' },
  { id: 'gpt-5-chat-latest', label: 'GPT-5 Chat Latest', provider: 'openai', type: 'text', input: 0.65, output: 0.65, ctx: '1M' },
  { id: 'gpt-5-mini', label: 'GPT-5 mini', provider: 'openai', type: 'text', input: 0.64, output: 0.64, ctx: '1M' },
  { id: 'gpt-5-mini-2025-08-07', label: 'GPT-5 mini 2025-08-07', provider: 'openai', type: 'text', input: 0.64, output: 0.64, ctx: '1M' },
  { id: 'gpt-5-nano', label: 'GPT-5 nano', provider: 'openai', type: 'text', input: 0.62, output: 0.62, ctx: '1M' },
  { id: 'gpt-5-nano-2025-08-07', label: 'GPT-5 nano 2025-08-07', provider: 'openai', type: 'text', input: 0.62, output: 0.62, ctx: '1M' },
  { id: 'gpt-5-search-api', label: 'GPT-5 Search API', provider: 'openai', type: 'text', input: 0.66, output: 0.66, ctx: '1M' },
  { id: 'gpt-5-search-api-2025-10-14', label: 'GPT-5 Search API 2025-10-14', provider: 'openai', type: 'text', input: 0.66, output: 0.66, ctx: '1M' },
  { id: 'o4-mini', label: 'o4-mini', provider: 'openai', type: 'text', input: 0.72, output: 0.72, ctx: '200K' },
  { id: 'o4-mini-2025-04-16', label: 'o4-mini 2025-04-16', provider: 'openai', type: 'text', input: 0.72, output: 0.72, ctx: '200K' },
  { id: 'o3', label: 'o3', provider: 'openai', type: 'text', input: 0.75, output: 0.75, ctx: '200K' },
