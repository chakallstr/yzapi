...
describe("Claude Popusk migration contract", () => {
  ...
  it("uses customer-facing text prices without exposing internal normalization", () => {
    ...
    expect(computePrice(byId.get("claude-haiku-4-5-20251001")!, pricingCfg).input?.usd).toBeCloseTo(0.52, 6);
    ...
    expect(computePrice(byId.get("claude-opus-4-7")!, pricingCfg).input?.usd).toBeCloseTo(1.0, 6);
